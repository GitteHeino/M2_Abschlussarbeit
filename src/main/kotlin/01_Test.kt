...
fun main(){
    ...
    var produktGesund = U1_Gesundheit("Mund- und Rachenspülung antiviral, fluoridfrei ab 6 Jahren, 300 ml", 7.95, 4.5,"Hals gurgeln", "",false)
    ...
    var produktGesund4 = U1_Gesundheit("Mund ", 7.95,4.9,"Hals gurgeln", "", true)
