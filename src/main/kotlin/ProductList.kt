...
object ProductList {
    ...
    val productList: MutableList<Produkt> = mutableListOf(
            ...
            P11_BodyCare(1, "Sonnenfluid Gesicht, 50ml", 4.75, 3.8, "sensitiv LSF 50+", "all", "L"),
            ...
            P22_Reinigungsmittel(12, "Vileda Ultramax Bodenwischer", 41.51, 4.4, "Komplett Ultramax Set + 2 extra Bezüge", "nicht verschlucken!", "innen")
